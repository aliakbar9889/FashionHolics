    ...
    <div data-aos="fade-up" className="h-full bg-orange-100 flex flex-col items-center p-6">
      ...
      >
        ...
        <div className="relative bg-white rounded-lg shadow-lg overflow-hidden group">
          ...
          <div className="p-4">
            <h3 className="text-xl font-semibold text-gray-800">Regal Heritage&apos;s</h3>
        ...
        <div className="relative bg-white rounded-lg shadow-lg overflow-hidden group">
          ...
          <div className="p-4">
            <h3 className="text-xl font-semibold text-gray-800">Urban Maverick&apos;s</h3>
        ...
        <div className="relative bg-white rounded-lg shadow-lg overflow-hidden group">
          ...
          <div className="p-4">
            <h3 className="text-xl font-semibold text-gray-800">Vintage Valor&apos;s</h3>
        ...
        <div className="relative bg-white rounded-lg shadow-lg overflow-hidden group">
          ...
          <div className="p-4">
            <h3 className="text-xl font-semibold text-gray-800">Alpine Guardian&apos;s</h3>
        ...
        <div className="relative bg-white rounded-lg shadow-lg overflow-hidden group">
          ...
          <div className="p-4">
            <h3 className="text-xl font-semibold text-gray-800">Luxe Noir&apos;s</h3>
        ...
        <div className="relative bg-white rounded-lg shadow-lg overflow-hidden group">
          ...
          <div className="p-4">
            <h3 className="text-xl font-semibold text-gray-800">Winter Wanderer&apos;s</h3>
        ...
        <div className="relative bg-white rounded-lg shadow-lg overflow-hidden group">
          ...
          <div className="p-4">
            <h3 className="text-xl font-semibold text-gray-800">Street Chic&apos;s</h3>
        ...
        <div className="relative bg-white rounded-lg shadow-lg overflow-hidden group">
          ...
          <div className="p-4">
            <h3 className="text-xl font-semibold text-gray-800">Bold Breeze&apos;s</h3>
